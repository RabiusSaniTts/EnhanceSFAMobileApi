...
class Hhctransaction_LoadViewController extends Hhctransaction_Library_Controller_Action_Abstract
{
      /**
    * @name       init
    * @since      01-02-2012
    ...
    */
	 ...
	 public function getrouteinfoAction()
    {
		...
		$route_info = $this->SFA_Comman->executequery('CALL tts_get_day_load(?)',$param_array,'');		
		//echo Zend_Json_Encoder::encode($route_info);
		//var_dump( $route_info[0]);
		//var_dump ($route_info[0][0]);
		echo "<p> <font color=blue size='10pt'> LOAD DATE : ".$route_info[0][0]['ddate']." </font> </p>";		
		echo "<br>";
		echo "<p> <font color=blue size='10pt'> LOAD No : ".$route_info[0][0]['loadperiodnumber']." </font> </p>";		
		echo "<br>";
		echo "<p> <font color=blue size='10pt'> ITEM COUNT : ".$route_info[0][0]['itemcount']." </font> </p>";		
		
		//$this->view->formdata 	= $route_info;
		exit;
    }
