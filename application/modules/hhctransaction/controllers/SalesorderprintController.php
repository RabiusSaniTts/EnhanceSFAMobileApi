...
class Hhctransaction_SalesorderprintController extends Hhctransaction_Library_Controller_Action_Abstract
{
      /**
    * @name       init
    * @since      01-02-2012
    ...
    */
	...
	public function salesorderpdfAction()
	{
	...
	$html .='</td>';
	$html .='<td>';
	$html .= $invoice_header['comments2'];
	$html .='</td>';
	$html .='<td>';
	$html .= "<b>Delivery Date : </b>";
	$html .='</td>';
	$html .='<td>';	
	$html .= ($invoice_header['orderdeliverydate'] != '0000-00-00 00:00:00') ? date('d-m-Y',strtotime($invoice_header['orderdeliverydate'])) : '';
	$html .='</td>';	
	$html .='</tr>';
	  ...
	  $html .='</tr>'; 		   
	  $html .='</table>';
	  $html .="<h3 style='text-align:center'>Order No.".$invoice_header['invoicenumber']."</h3>";
	  /**/
	...
	$result_grid = $this->SFA_Comman->executequery('CALL sp_get_transaction_index_salesorderdetailgrid_print(?,?,?,?,?,?,?)',$param_array,'');   
	...
	if(($freecount != "0" && $freecount != NULL) || $promocount != "0")
	{
	  $html .='<br>';
	...
	/**/
	 ...
	 /*Following code for total*/
	
	$html .='<table>';
	
	$html .='<tr>'; 
	$html .='<td >';
	$html .= "<b>Total Order Amount : </b>";
	$html .='</td>';
	$html .='<td style="width:120px;">';
	$html .= number_format($invoice_header['totalsalesamount'],$this->decimalplaces);
	$html .='</td>';
	$html .='<td >';
	$html .= "<b>Final Order Amount : </b>";
	$html .='</td>';
	$html .='<td >';
	...
	$html .='</td>'; 
	$total_order_dis = ($invoice_header['totalpromoamount']-$result[3][0]['promoamount']);
	
	$html .='<td>';	
	$html .= "<b>Total Order Discount : </b>";
	$html .='</td>';
	$html .='<td>';	
	$html .= number_format($total_order_dis,$this->decimalplaces);
	$html .='</td>';
	$html .='</tr>';
