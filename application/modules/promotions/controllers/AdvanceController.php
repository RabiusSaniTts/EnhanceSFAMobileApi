    ...
    */
    public function addpromotionplanAction()
    {
		...
		if($formdata['txt_plandescription'])
		{
			...
			$param_array[14] = $formdata['chk_repeatrange'];
		...
		else
		{
			...
			$promotion_type[] = array("id"=>"8","val"=>"8 - Combo Promotion");
