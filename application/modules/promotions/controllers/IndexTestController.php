...
*/
class Promotions_IndexTestController extends Promotions_Library_Controller_Action_Abstract
{
    ...
    */
    public function qualificationgrpitemgridAction()
    {
		...
		$param_array[7] = ($params['key'] <> "" ? ' AND pgh.grouptype = 1  AND pgh.groupnumber ='.$params['key'].' ': ' AND pgh.grouptype = 1 ');
