...
*/
class Datamanagement_ImportController extends Datamanagement_Library_Controller_Action_Abstract
{
    /**
    * @name       init
    * @since      24 July, 2012
    ...
    */
    public function importcsvAction()
    {
        ...
        if(count($formdata) > 0 && isset($formdata['submit_file']) && $formdata['submit_file'] !='' )
        {
            ...
            $this->_helper->redirector("importcsv", "import", "datamanagement");
        }
