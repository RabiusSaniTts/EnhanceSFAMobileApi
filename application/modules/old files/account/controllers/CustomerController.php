...
class Account_CustomerController extends Account_Library_Controller_Action_Abstract
{
    ...
    */
    public function addcustomerAction()
    {
		...
		if($formdata['txtcode'] && $formdata['txtname'])
		{
            ...
            $param_array[49] = ($formdata['ddldis_msg_key2'] > 0) ? $formdata['ddldis_msg_key2'] : 'NULL';            		//messagekey2
    ...
    */   
    ...
    $param_setting2_array[31]  = $formdata['txtroundingoff'];	//roundingoffvalue
  ...
  /**
    ...
    */
    public function itemmustitemgridAction()
    {
        ...
        $columns_array = array('im.actualitemcode','im.itemshortdescription AS itemshortdescription','CONCAT(primary_key,"_",ith.itemmustcode) AS edit_del_primary_id');        
        $columns_show =  array($this->translate->_('Item Code'),$this->translate->_('Item Description'));
