...
class Account_CustomerController extends Account_Library_Controller_Action_Abstract
{
    ...
    */
    public function addcustomerAction()
    {
		...
		if($formdata['txtcode'] && $formdata['txtname'])
		{
			...
			$param_array[25] = $formdata['txtexp_limit'];			//expirylimit
		...
		elseif($params['id'] > 0)
		{
			...
			$res['txtexp_limit'] 	= $result[4][0]['expirylimit'];
    ...
    */    
	...
	$priceprint[0]['id'] 		= '0';
	$priceprint[1]['id'] 		= '1';
	$priceprint[0]['val'] 		= 'Do Not Print Price/ Amount Details';
	$priceprint[1]['val'] 		= 'Print Price/ Amount Details';
