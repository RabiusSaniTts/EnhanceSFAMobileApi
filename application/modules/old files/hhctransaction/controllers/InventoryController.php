...
class Hhctransaction_InventoryController extends Hhctransaction_Library_Controller_Action_Abstract
{
    ...
    */
    public function customerinventoryAction()
    {
		...
		$cols_array 	= array('DISTINCT rm.routecode','rm.routename','rm.salesmancode','coc.visitstartdate visitdate','cm.customercode','cm.alternatecode','cm.customername','coc.primary_id AS edit_del_primary_id');
