  ...
  /**
    ...
    */
    ...
    public function dailyrouteactivitydataAction()
    {
        ...
        if(!empty($result_arr[0])) {
            for($j = $start; $j < count($result_arr[0]); $j++,$i++)
            {
                ...
                $responce->rows[$i]['cell'] = array($result_arr[0][$j]['routecode'].'-'.$routename,$result_arr[0][$j]['trandate'],$result_arr[0][$j]['documentno'],$customer,$address,$result_arr[0][$j]['trandate'],$result_arr[0][$j]['visitstarttime'],$result_arr[0][$j]['visitendtime'], $this->gettimediff($result_arr[0][$j]['visitstarttime'] , $result_arr[0][$j]['visitendtime']) ,$result_arr[0][$j]['trantype'],$result_arr[0][$j]['tranamount'],$result_arr[0][$j]['salePaid'],$result_arr[0][$j]['receiptPaid']);
            }
        }
    ...
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route'),$this->translate->_('Transaction Date'),$this->translate->_('Document Number'),$this->translate->_('Customer'),$this->translate->_('Address'),$this->translate->_('Transaction Date'),$this->translate->_('Visit Start Time'),$this->translate->_('Visit End Time'),$this->translate->_('Duration hh:mm'),$this->translate->_('Transaction'),$this->translate->_('Total Transaction Amount'),$this->translate->_('Invoice Amount Collected'),$this->translate->_('Receipt Amount Collected'));
        ...
        for($i = 0; $i < count($result_arr[0]); $i++)
        {
            ...
            $column_model_arr[$result_arr[0][$i]['routecode'].'-'.$routename][$result_arr[0][$i]['trandate']][] = array($result_arr[0][$i]['documentno'],$customer,$address,$result_arr[0][$i]['trandate'],$result_arr[0][$i]['visitstarttime'],$result_arr[0][$i]['visitendtime'], $this->gettimediff($result_arr[0][$i]['visitstarttime'] , $result_arr[0][$i]['visitendtime']) ,$result_arr[0][$i]['trantype'],$result_arr[0][$i]['tranamount'],$result_arr[0][$i]['salePaid'],$result_arr[0][$i]['receiptPaid']);
        }
