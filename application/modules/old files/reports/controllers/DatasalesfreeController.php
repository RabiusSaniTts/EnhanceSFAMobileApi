...
class Reports_DatasalesfreeController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Sales Free Summary";
    ...
    public function salesfreeAction()
    {
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $total_defaultsalesprice += $row['defaultsalesprice'];
                ...
                $total_salesdefprice += $row['salesdefprice'];
                ...
                $responce->rows[$i]['cell']=array($row['routecode']." - ".$routename,$row['salesmancode']." - ".$salesmanname,
                                                  ...
                                                  $row['returnqty'], $row['defaultsalesprice'], $row['salesinvprice'], $row['damagestdprice'],
                                                  ...
                                                  $row['salesdefprice'],$totalfoc,$netqty,$netamount
                                                  );
                $i++;
            }
        }
        ...
        $responce->userdata['unitspercase'] = $this->translate->_("Total");
    ...
    */
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route'),$this->translate->_('Salesman'),$this->translate->_('Item Group'),$this->translate->_('Item Code'),$this->translate->_('Item Description'),$this->translate->_('UPC'),$this->translate->_('Sales Qty'),$this->translate->_('Free Qty'),$this->translate->_('Damaged Qty'),$this->translate->_('Expired Qty'),$this->translate->_('Good Ret. Qty'),$this->translate->_('Sales @ Std. Price'),$this->translate->_('Sales @ Inv. Price'),$this->translate->_('Damage Ret @ Std. Price'),$this->translate->_('Damage Ret @ Inv. Price'),$this->translate->_('Expired Ret @ Std. Price'),$this->translate->_('Expired Ret @ Inv. Price'),$this->translate->_('Good Return @ Std. Price'),$this->translate->_('Good Return @ Inv. Price'),$this->translate->_('Inv. Discount Break Up'),$this->translate->_('Item Discount Break Up'),$this->translate->_('Free Goods @ Std. Price'),$this->translate->_('Price Difference'),$this->translate->_('Total FOC'),$this->translate->_('Net Sales Qty'),$this->translate->_('Net Sales Amount'));
        ...
        for($i = 0; $i < count($result_arr[0]); $i++)
        {
            ...
            $itemgroup = ($this->css == 'ar_') ? $result_arr[0][$i]['arbitemgroup'] : $result_arr[0][$i]['itemgroupname'];
            $description = ($this->css == 'ar_') ? $result_arr[0][$i]['arbdescription'] : $result_arr[0][$i]['majorcategory'];
            $itemdescription = ($this->css == 'ar_') ? $result_arr[0][$i]['arbitemdescription'] : $result_arr[0][$i]['itemdescription'];
            
            $totalfoc = $result_arr[0][$i]['freegodsstdprice']+$result_arr[0][$i]['invdiscountbreakup']+$result_arr[0][$i]['itempromodiscount']+$result_arr[0][$i]['salesdefprice']+$result_arr[0][$i]['salesinvprice']+$result_arr[0][$i]['damagestdprice']+$result_arr[0][$i]['damageinvprice']+$result_arr[0][$i]['expiredstdprice']+$result_arr[0][$i]['expiredinvprice']+$result_arr[0][$i]['goodretunstdprice']+$result_arr[0][$i]['goodretuninvprice'];
            $netqty = $result_arr[0][$i]['salesqty']+$result_arr[0][$i]['freesampleqty']-$result_arr[0][$i]['damagedqty']-$result_arr[0][$i]['expiryqty']-$result_arr[0][$i]['returnqty'];
            $netamount = $result_arr[0][$i]['salesinvprice']+$result_arr[0][$i]['damageinvprice']+$result_arr[0][$i]['expiredinvprice']+$result_arr[0][$i]['goodretuninvprice']+$result_arr[0][$i]['invdiscountbreakup']+$result_arr[0][$i]['itempromodiscount'];
               
            $column_model_arr[$result_arr[0][$i]['routecode']." - ".$routename][$result_arr[0][$i]['salesmancode']." - ".$salesmanname][$result_arr[0][$i]['itemgroupcode']." - ".$itemgroup][] = array($result_arr[0][$i]['itemcode'], $itemdescription,$result_arr[0][$i]['unitspercase'],$result_arr[0][$i]['salesqty'],$result_arr[0][$i]['freesampleqty']
                              , $result_arr[0][$i]['damagedqty'], $result_arr[0][$i]['expiryqty'], $result_arr[0][$i]['returnqty'], $result_arr[0][$i]['defaultsalesprice'], $result_arr[0][$i]['salesinvprice'], $result_arr[0][$i]['damagestdprice'], $result_arr[0][$i]['damageinvprice'], $result_arr[0][$i]['expiredstdprice'], $result_arr[0][$i]['expiredinvprice'], $result_arr[0][$i]['goodretunstdprice'], $result_arr[0][$i]['goodretuninvprice'],
                              $result_arr[0][$i]['invdiscountbreakup'], $result_arr[0][$i]['itempromodiscount'], $result_arr[0][$i]['freegodsstdprice'], $result_arr[0][$i]['salesdefprice'],$totalfoc,$netqty,$netamount);
        }
