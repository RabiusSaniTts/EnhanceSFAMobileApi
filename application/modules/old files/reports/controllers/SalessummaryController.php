...
class Reports_SalessummaryController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
               // print_r($row);
                ...
                $responce->rows[$i]['cell'] = array($row['routecode']." - ".$routename,$row['hocode']." - ". $row['honame'],$row['transactiondate'],
                                                    ...
                                                    $netamount,$row['immediatepaid'],$row['invoicebalance']
                                                    );
                $i++;
            }
        }
    ...
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route Code'),$this->translate->_('HO Code'),$this->translate->_( 'Transaction Date'),$this->translate->_('Transaction Time'),$this->translate->_('Invoice Number'),$this->translate->_('Salesman Code'),$this->translate->_('Customer Code'),$this->translate->_('Customer Name'),$this->translate->_('Payment Type'),$this->translate->_('Sales Amount'),$this->translate->_('Good Return Amount'),$this->translate->_('Damage Return Amount'),$this->translate->_('Expiry Return Amount'),$this->translate->_('Free Amount'),$this->translate->_('Invoice Amount'),$this->translate->_('Discount Amount'),$this->translate->_('Net Amount'),$this->translate->_('Immediate Paid'),$this->translate->_('Invoice Balance'));
        ...
        for($i = 0; $i < count($result_arr[0]); $i++)
        {
            ...
            $column_model_arr[$result_arr[0][$i]['routecode']." - ".$routename][$result_arr[0][$i]['hocode']." - ". $result_arr[0][$i]['honame']][$result_arr[0][$i]['transactiondate']][] =
