...
class Reports_RouteinventoryController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Route Inventory";
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $responce->rows[$i]['cell'] = array($row['routecode']." - ".$routename,$row['majorcategorycode']." - ".$majorcategory,$row['actualitemcode'],$itemdescription,
                                                    (int)$row['beginqtycase'],(int)$row['beginqtypcs'],(int)$row['loadqtycase'],(int)$row['loadqtypcs'],(int)$row['loadaddqtycase'],(int)$row['loadaddqtypcs'],
                                                    (int)$row['loadcutqtycase'],(int)$row['loadcutqtypcs'],(int)$row['salesqtycase'],(int)$row['salesqtypcs'],(int)$row['returnqtycase'],(int)$row['returnqtypcs'],
                                                    (int)$row['damagedqtycase'],(int)$row['damagedqtypcs'],(int)$row['expiryqtycase'],(int)$row['expiryqtypcs'],(int)$row['freesampleqtycase'],(int)$row['freesampleqtypcs'],
                                                    (int)$row['manualfreeqtycase'],(int)$row['manualfreeqtypcs'],(int)$row['endqtycase'],(int)$row['endqtypcs'],$row['truckstockvalue'],$row['endstockvalue']
                                                );
                $i++;
            }
        }
    ...
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route'),$this->translate->_('Group'),$this->translate->_('Item Code'),$this->translate->_('Item Description'),$this->translate->_('Opening Case'),$this->translate->_('Opening Pcs'),$this->translate->_('Load Case'),$this->translate->_('Load Pcs'),$this->translate->_('Transfer IN Case'),$this->translate->_('Transfer IN Pcs'),$this->translate->_('Transfer OUT Case'),$this->translate->_('Transfer OUT Pcs'),$this->translate->_('Sales Case'),$this->translate->_('Sales Pcs'),$this->translate->_('Good Return Case'),$this->translate->_('Good Return Pcs'),$this->translate->_('Damaged Case'),$this->translate->_('Damaged Pcs'),$this->translate->_('Expiry Case'),$this->translate->_('Expiry Pcs'),$this->translate->_('Promo Free Case'),$this->translate->_('Promo Free Pcs'),$this->translate->_('Manual Sample Case'),$this->translate->_('Manual Sample Pcs'),$this->translate->_('Closing Case'),$this->translate->_('Closing Pcs'),$this->translate->_('Load Value'),$this->translate->_('Closing Value'));
        $data_arr["columns_config"] = array(array("width"=>13),
                                            ...
                                            array("width"=>8,"total"=>"1","group_total"=>"1"),
                                            array("width"=>10,"total"=>"1","group_total"=>"1"),
                                            array("width"=>10,"total"=>"1","group_total"=>"1"),
                                            array("width"=>10,"total"=>"1","group_total"=>"1"),
                                            array("width"=>10,"total"=>"1","group_total"=>"1"),
        ...
        for($i = 0; $i < count($result_arr[0]); $i++)
        {
            ...
            $salesmanname = ($this->session->lang == "ar_AR") ? $result_arr[0][$i]['arbsalesmanname1'] : $result_arr[0][$i]['salesman'];
            $majorcategory = ($this->session->lang == "ar_AR") ? $result_arr[0][$i]['arbmajorcatdes'] : $result_arr[0][$i]['majorcategroy'];
            $itemdescription = ($this->session->lang == "ar_AR") ? $result_arr[0][$i]['arbitemdescription'] : $result_arr[0][$i]['itemdescription'];
            
            $column_model_arr[$result_arr[0][$i]['routecode']." - ".$routename][$result_arr[0][$i]['majorcategorycode']." - ".$majorcategory][]
                = array($result_arr[0][$i]['actualitemcode'],$itemdescription,(int)$result_arr[0][$i]['beginqtycase'],(int)$result_arr[0][$i]['beginqtypcs']
                        ,(int)$result_arr[0][$i]['loadqtycase'],$result_arr[0][$i]['loadqtypcs'],(int)$result_arr[0][$i]['loadaddqtycase'],(int)$result_arr[0][$i]['loadaddqtypcs'],
                                                    (int)$result_arr[0][$i]['loadcutqtycase'],(int)$result_arr[0][$i]['loadcutqtypcs'],(int)$result_arr[0][$i]['salesqtycase'],(int)$result_arr[0][$i]['salesqtypcs'],(int)$result_arr[0][$i]['returnqtycase'],(int)$result_arr[0][$i]['returnqtypcs'],
                                                    (int)$result_arr[0][$i]['damagedqtycase'],(int)$result_arr[0][$i]['damagedqtypcs'],(int)$result_arr[0][$i]['expiryqtycase'],(int)$result_arr[0][$i]['expiryqtypcs'],(int)$result_arr[0][$i]['freesampleqtycase'],(int)$result_arr[0][$i]['freesampleqtypcs'],
                                                    (int)$result_arr[0][$i]['manualfreeqtycase'],(int)$result_arr[0][$i]['manualfreeqtypcs'],(int)$result_arr[0][$i]['endqtycase'],(int)$result_arr[0][$i]['endqtypcs'],$result_arr[0][$i]['truckstockvalue'],$result_arr[0][$i]['endstockvalue']
                        );
        }
