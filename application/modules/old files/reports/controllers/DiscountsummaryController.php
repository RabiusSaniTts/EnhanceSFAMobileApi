  ...
  /**
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Discount Summary";
    ...
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Transaction Date'),$this->translate->_('Transaction Time'),$this->translate->_('Invoice Number'),$this->translate->_('Customer Code'),$this->translate->_('Customer Name'),$this->translate->_('Sales Amount'),$this->translate->_('Good Ret. Amount'),$this->translate->_('Dmged Ret.Amount'),$this->translate->_('Expiry Ret.Amount'),$this->translate->_('Free Amount'),$this->translate->_('Invoice Amount'),$this->translate->_('Discount Amount'),$this->translate->_('Net Amount'));
