...
*/
class Merchandize_PosController extends Merchandize_Library_Controller_Action_Abstract
{
    public $sec_lang 		= '';
    /**
    * @name       init
    ...
    */
    public function indexAction()
    {
		...
		$pagingparams = array(
				...
				"primaryid" => "itemcode",
				"editlink" => array("/merchandize/pos/addpos/id/#pattern#/edit/yes/","#pattern#"),
    ...
    */
	...
	if($formdata['txtitemdesc'] !='')
	{
		...
		$this->_helper->redirector('index', 'pos', 'merchandize');
	}
	elseif($params['id'] > 0)
	{
    ...
    */
	...
	$pagingparams = array(
			...
			"editlink" => array("/merchandize/pos/addposinstruction/id/#pattern#/edit/yes/","#pattern#"),
			"nodata_message" => $this->translate->_('No Record(s) Found'),
			"fetch_columns_inquery" => $cols_array,
			"show_columns" => $columns_show
			);
    ...
    */
	...
	if($formdata['txtname'] !='')
	{
		...
		$this->_helper->redirector('posinstruction', 'pos', 'merchandize');
	}
	elseif($params['id'] > 0)
	{
    ...
    */
	...
	$pagingparams = array(
			...
			"editlink" => array("/merchandize/pos/addcustomerposlimit/id/#pattern#/edit/yes/","#pattern#"),
			"nodata_message" => $this->translate->_('No Record(s) Found'),
			"fetch_columns_inquery" => $cols_array,
			"show_columns" => $columns_show
			);
    ...
    */
        ...
        if(($formdata['ddlcustomer'] > 0 || $formdata['hdncustomercode'] > 0) && $formdata['txtposlimit'] !='')
	{
		...
		if($formdata["returnUrl"]!="")
		    ...
		    $this->_helper->redirector('customerposlimit', 'pos', 'merchandize');
	    }
	    else
	    {
		...
		if($formdata["returnUrl"]!="")
		    ...
		    $this->_helper->redirector('addcustomerposlimit', 'pos', 'merchandize',array('edit'=>'yes','id'=>$last_id));
	    }
