...
class Basic_IndexController extends Basic_Library_Controller_Action_Abstract
{
    ...
    */
	...
	if($formdata['txtcode'] && $formdata['txtcom_name'] && $formdata['txtaddress'] && $formdata['txttel_num'])
	{
		...
		$param_array[12] = trim($formdata['txtdis_code1']);	//distributorcode1
		$param_array[13] = trim($formdata['txtdis_code2']); 	//distributorcode2
		...
		$param_array[17] = trim($formdata['txten_footer_note']);
		$param_array[18] = trim($formdata['txtarb_footer_note']);
		$param_array[19] = trim($formdata['txten_footer_label']);
		$param_array[20] = trim($formdata['txtarb_footer_label']);
		...
		$param_array[16] = trim($formdata['txten_footer_note']);
		$param_array[17] = trim($formdata['txtarb_footer_note']);
		$param_array[18] = trim($formdata['txten_footer_label']);
		$param_array[19] = trim($formdata['txtarb_footer_label']);
	...
	elseif($params['id'] > 0)
	{
	    ...
	    $res['txtdis_code1'] 	= $result[0][0]['distributorcode1'];
	    $res['txtdis_code2'] 	= $result[0][0]['distributorcode2'];
	    $res['ddlstatus'] 		= $result[0][0]['activestatus'];
	    $res['createddate'] 	= date('d-m-Y',strtotime($result[0][0]['cdat']));
		$res['txten_footer_note'] 		= $result[0][0]['enfooternote'];
	    $res['txtarb_footer_note'] 		= $result[0][0]['arbfooternote'];
	    $res['txten_footer_label'] 		= $result[0][0]['enlabelfooternote'];
	    $res['txtarb_footer_label'] 		= $result[0][0]['arblabelfooternote'];
	    $this->view->formdata 	= $res;
