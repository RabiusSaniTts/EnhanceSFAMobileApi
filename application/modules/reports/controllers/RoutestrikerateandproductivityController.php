...
*/
class Reports_RoutestrikerateandproductivityController extends Reports_Library_Controller_Action_Abstract
{
     /**
    * @name       init
    * @since      01-10-2012
    ...
    */
    ...
    public function routestrikerateandproductivityAction()
    {
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Route Strike Rate And Productivity";
       ...
       //  print_r($this->view->searchParams);
        $this->view->xlsexport_link = $this->view->baseUrl()."/reports/routestrikerateandproductivity/export";
        $this->view->cvsexport_link = $this->view->baseUrl()."/reports/routestrikerateandproductivity/exportcsv";
    }
    /**
    ...
    public function routestrikerateandproductivitydataAction()
    {
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $responce->rows[$i]['cell']=array($row['routecode'],$routename,$salesmanname,$row['plannedcalls'],$row['actualcalls'],$row['cashsale'],$row['creditsale'],$row['totalreceipt'],$row['productivecalls'],$row['strikerate'],$row['productiverate']);
                $i++;
