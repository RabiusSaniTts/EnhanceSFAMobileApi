...
*/
class Reports_CustomermslcapturedController extends Reports_Library_Controller_Action_Abstract
{
     /**
    * @name       init
    * @since      15-02-2012
    ...
    */
    ...
    public function customermslcapturedAction()
    {
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "MSL DATA Captured/Not Captured";
        ...
        $this->view->xlsexport_link = $this->view->baseUrl()."/reports/customermslcaptured/export";
        $this->view->cvsexport_link = $this->view->baseUrl()."/reports/customermslcaptured/exportcsv";
    }
    /**
    ...
    *
    */
    public function customermslcaptureddataAction()
    {
        $this->view->params = $params = $this->getRequest()->getParams();
        $this->view->formdata = $formdata = $this->_request->getPost();
        ...
        {
            $extra_where .= ' AND soh.routecode =  "'.$this->report_session->post['ddlroute'].'"';
        }
       ...
       // print_r($param_array);exit;
        $result_arr = $this->SFA_Comman->executequery('CALL sp_report_msl_captured_list(?,?,?,?,?,?)',$param_array,'');
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $responce->rows[$i]['cell']=array(
                    $row['route'],$row['salesman'],$row['customer'],$row['categoryname'],$row['customername'],
                    $row['itemmustdescription'],
                    $row['itemcode'],$row['itemshortdescription'],$row['unitspercase'],
                    $row['loadqty'],$row['custqty'],$row['salesqty'],$row['transactiondate']);
                $i++;
    ...
    */
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array(
            $this->translate->_('Route code'),
            $this->translate->_('Salesman Name'),
            $this->translate->_('Customer Code'),
            $this->translate->_('Customer Group'),
            $this->translate->_('Customer Name'),
            $this->translate->_('MSL Description'),
            $this->translate->_('Item Code'),
            $this->translate->_('Item Description'),
            $this->translate->_('Item UPC'),
            $this->translate->_('Load Qty'),
            $this->translate->_('CSS Qty'),
            $this->translate->_('Sales Qty'),
            $this->translate->_('Date Captured')
        );
        ...
        {
            $column_model_arr[] = array($data[$i]['route'],$data[$i]['salesman'],$data[$i]['customer'],$data[$i]['categoryname'],$data[$i]['customername'],$data[$i]['categoryname'],
                $data[$i]['itemcode'],$data[$i]['itemshortdescription'],$data[$i]['unitspercase'],
                $data[$i]['loadqty'],$data[$i]['custqty'],$data[$i]['salesqty'],$data[$i]['transactiondate']);
