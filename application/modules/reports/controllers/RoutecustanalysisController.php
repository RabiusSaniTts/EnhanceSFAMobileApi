...
*/
class Reports_RoutecustanalysisController extends Reports_Library_Controller_Action_Abstract
{
     /**
    * @name       init
    * @since      01-10-2012
    ...
    */
    ...
    public function routecustanalysisAction()
    {
        $this->view->params 	= $params = $this->getRequest()->getParams();
        $this->view->formdata  = $formdata = $this->_request->getPost();
		$param_checkarray 	= array();			
		$param_checkarray[1]	= "DATA";
		$result_arr = $this->SFA_Comman->executequery('CALL proc_tts_route_cust_analysis()','','');	
        $this->view->analysisdata =$result_arr[0];
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Route Monthly Revenue";
