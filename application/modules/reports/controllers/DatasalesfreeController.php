    ...
    */
    public function exportAction()
    {
        ...
        for($i = 0; $i < count($result_arr[1]); $i++)
        {
            ...
            $itemgroup = ($this->css == 'ar_') ? $result_arr[1][$i]['arbitemgroup'] : $result_arr[1][$i]['itemgroupname'];
            $description = ($this->css == 'ar_') ? $result_arr[1][$i]['arbdescription'] : $result_arr[1][$i]['majorcategory'];
            $itemdescription = ($this->css == 'ar_') ? $result_arr[1][$i]['arbitemdescription'] : $result_arr[1][$i]['itemdescription'];
            
           
			 $totalfoc = $result_arr[1][$i]['freegodsstdprice']+$result_arr[1][$i]['invdiscountbreakup']+$result_arr[1][$i]['itempromodiscount'];
		  
			$netqty = $result_arr[1][$i]['salesqty']+$result_arr[1][$i]['freesampleqty']-$result_arr[1][$i]['damagedqty']-$result_arr[1][$i]['returnqty'];
		 
           $netamount = $result_arr[1][$i]['salesinvprice']+$result_arr[1][$i]['damageinvprice']+$result_arr[1][$i]['goodretuninvprice']+$result_arr[1][$i]['invdiscountbreakup']+$result_arr[1][$i]['itempromodiscount'];    
           
		 //  $column_model_arr[$result_arr[1][$i]['transactiondate']][$result_arr[1][$i]['routecode']." - ".$routename][$result_arr[1][$i]['itemgroupcode']." - ".$itemgroup][] = array($result_arr[1][$i]['itemcode'], $itemdescription,$result_arr[1][$i]['upc'],$result_arr[1][$i]['salesqty'],$result_arr[1][$i]['freesampleqty']
          //                    , $result_arr[1][$i]['damagedqty'], /*$result_arr[0][$i]['expiryqty'],*/ $result_arr[1][$i]['returnqty'], $result_arr[1][$i]['salesdefprice'], $result_arr[1][$i]['salesinvprice'], $result_arr[1][$i]['damagestdprice'], $result_arr[1][$i]['damageinvprice'],/* $result_arr[0][$i]['expiredstdprice'], $result_arr[0][$i]['expiredinvprice'],*/ $result_arr[1][$i]['goodretunstdprice'], $result_arr[1][$i]['goodretuninvprice'],
          //                    $result_arr[1][$i]['invdiscountbreakup'], $result_arr[1][$i]['itempromodiscount'], $result_arr[1][$i]['freegodsstdprice'], $result_arr[1][$i]['pricediff'],$totalfoc,$result_arr[1][$i]['netqty'],$result_arr[1][$i]['netamount']);
		  		   $column_model_arr[$result_arr[1][$i]['transactiondate']][] = array([$result_arr[1][$i]['routecode']." - ".$routename],[$result_arr[1][$i]['itemgroupcode']." - ".$itemgroup],$result_arr[1][$i]['itemcode'], $itemdescription,$result_arr[1][$i]['upc'],$result_arr[1][$i]['salesqty'],$result_arr[1][$i]['freesampleqty']
                              , $result_arr[1][$i]['damagedqty'], /*$result_arr[0][$i]['expiryqty'],*/ $result_arr[1][$i]['returnqty'], $result_arr[1][$i]['salesdefprice'], $result_arr[1][$i]['salesinvprice'], $result_arr[1][$i]['damagestdprice'], $result_arr[1][$i]['damageinvprice'],/* $result_arr[0][$i]['expiredstdprice'], $result_arr[0][$i]['expiredinvprice'],*/ $result_arr[1][$i]['goodretunstdprice'], $result_arr[1][$i]['goodretuninvprice'],
                              $result_arr[1][$i]['invdiscountbreakup'], $result_arr[1][$i]['itempromodiscount'], $result_arr[1][$i]['freegodsstdprice'], $result_arr[1][$i]['pricediff'],$totalfoc,$result_arr[1][$i]['netqty'],$result_arr[1][$i]['netamount']);
