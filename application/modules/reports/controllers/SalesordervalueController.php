    ...
    public function salesordervaluedataAction()
    {
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $responce->rows[$i]['cell']=array($row['routecode'],$routename,$row['salesmancode'],$salesmanname,$row['customercode'],$customername,$row['itemcode'],$itemshortdescription,$row['channel'],$row['invoicenumber'],$row['invoicedate'],$row['invoicepayment'],$row['salesqty'],$row['salesvalue'],$row['alternateitemgroupcode'],$row['Outlet_Quality']);
                $i++;
    ...
    */
    public function exportAction()
    {
        ...
        for($i = 0; $i < count($data); $i++)
        {
            ...
            $column_model_arr[] = array($data[$i]['routecode'],$routename,$data[$i]['salesmancode'],$salesmanname,$data[$i]['customercode'],$customername,$data[$i]['itemcode'],$itemshortdescription,$data[$i]['channel'],$data[$i]['invoicenumber'],$data[$i]['invoicedate'],$data[$i]['invoicepayment'],$data[$i]['salesqty'],$data[$i]['salesvalue'],$data[$i]['alternateitemgroupcode'],$data[$i]['Outlet_Quality']);
        }
