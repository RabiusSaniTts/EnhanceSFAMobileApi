...
class Reports_OrdersummaryController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Order Summary";
    ...
    public function exportAction()
    {
        ...
        for($i = 0; $i < count($result_arr[0]); $i++)
        {
            $column_model_arr[$result_arr[0][$i]['routecode']." - ".$result_arr[0][$i]['routename']][$result_arr[0][$i]['transactiondate']][] =array($result_arr[0][$i]['transactiontime'],
                                                  $result_arr[0][$i]['invoicenumber'],$result_arr[0][$i]['receivedtime'],$result_arr[0][$i]['salesmancode'], $result_arr[0][$i]['customercode'],
                                                  $result_arr[0][$i]['customername'],$result_arr[0][$i]['invoiceamount']
                                                );
        }
