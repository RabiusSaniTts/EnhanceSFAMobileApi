...
*/
class Reports_RouteviewController extends Reports_Library_Controller_Action_Abstract
{
     /**
     * @name       init
     * @since      04-05-2015
     ...
     *
     */
     public function routeviewAction()
     {
     ...
     */
     public function indexAction()
     {
	  ...
	  $this->view->ReportTitle = "Route View";
	  ...
	  $result_arr = $this->SFA_Comman->executequery('CALL sp_report_routeview_index(?)',$param_array,'');
	  
	  $this->view->mapdata = $result_arr[1];
	  //var_dump($result_arr);
	  //die;
     }
     /**
     * @name       routesummarydataAction
     * @since      04-05-2015
     * @version    Release: 1
     * @author     CS <chetan@e2logy.com>
     * @copyright  Elan Technologies
     ...
     */
     public function exportAction()
     {
	  ...
	  $data_arr["columns"] = array($this->translate->_('Route (Salesman)'),$this->translate->_('Route Start Date'),$this->translate->_('Route Start Time'),$this->translate->_('Route End Date'),$this->translate->_('Route End Time'),$this->translate->_('Total Sales Documents'),$this->translate->_('Total Return Documents'),$this->translate->_('Total Cash Sales'),$this->translate->_('Total GC Sales'),$this->translate->_('Total TC Sales'),$this->translate->_('Total Invoiced Amount'),$this->translate->_('Total Receipt Documents'),$this->translate->_('Total Receipt Amount'),$this->translate->_('Total Cash'),$this->translate->_('Total Checks'),$this->translate->_('Total Order Amount'),$this->translate->_('Total Expenses'),$this->translate->_('Inventory Variance'),$this->translate->_('Cash Variance'));
