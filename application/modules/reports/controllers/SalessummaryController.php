...
*/
class Reports_SalessummaryController extends Reports_Library_Controller_Action_Abstract
{
    /**
    * @name       init
    * @since      15-02-2012
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Sales Summary";
        ...
        $this->view->xlsexport_link = $this->view->baseUrl()."/reports/salessummary/export";
        $this->view->cvsexport_link = $this->view->baseUrl()."/reports/salessummary/exportcsv";
    }
    ...
    /**
      ...
      *
      */
    public function salessummarydataAction()
    {
        $this->view->params = $params = $this->getRequest()->getParams();
        $this->view->formdata = $formdata = $this->_request->getPost();
        ...
        $result_arr = $this->SFA_Comman->executequery('CALL sp_report_transaction_salessummary_with_permission(?,?,?,?,?,?)',$param_array,'');
