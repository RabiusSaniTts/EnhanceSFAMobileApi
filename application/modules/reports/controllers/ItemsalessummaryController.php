    ...
    */
    ...
    public function exportAction()
    {
        ...
        for($i = 0; $i < count($result_arr[1]); $i++)
        {
			 ...
			 $netamount = $result_arr[1][$i]['salesinvprice']+$result_arr[1][$i]['damageinvprice']+$result_arr[1][$i]['expiryinvprice']+$result_arr[1][$i]['otherdamgeinvprice']+$result_arr[1][$i]['goodretuninvprice']+$result_arr[1][$i]['invdiscountbreakup']+$result_arr[1][$i]['itempromodiscount'];
            ...
            $majorcategory = ($this->css == 'ar_') ? $result_arr[1][$i]['arbdescription'] : $result_arr[1][$i]['majorcategory'];
            ...
            $column_model_arr[$result_arr[1][$i]['transactiondate']][$result_arr[1][$i]['majorcategorycode'].' - '.$majorcategory][$result_arr[1][$i]['itemgroupcode']." - ".$itemgroup][] =  array($result_arr[1][$i]['itemcode'], $itemdescription,
                                        $result_arr[1][$i]['upc'],$result_arr[1][$i]['salesqty'],$result_arr[1][$i]['freesampleqty'],$result_arr[1][$i]['damagedqty'], $result_arr[1][$i]['expiryqty'],
                                        $result_arr[1][$i]['returnqty'], $result_arr[1][$i]['salesdefprice'], $result_arr[1][$i]['salesinvprice'], $result_arr[1][$i]['damagestdprice'],
