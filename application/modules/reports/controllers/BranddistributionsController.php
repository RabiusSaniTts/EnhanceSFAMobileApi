...
*/
class Reports_BranddistributionsController extends Reports_Library_Controller_Action_Abstract
{
     /**
    * @name       init
    * @since      01-10-2012
    ...
    */
    ...
    public function branddistributionsAction()
    {
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Brand Distributions";
       ...
       //  print_r($this->view->searchParams);
        $this->view->xlsexport_link = $this->view->baseUrl()."/reports/branddistributions/export";
        $this->view->cvsexport_link = $this->view->baseUrl()."/reports/branddistributions/exportcsv";
    }
    /**
      ...
      *
      */
    public function branddistributionsdataAction()
    {
        $this->view->params = $params = $this->getRequest()->getParams();
        $this->view->formdata = $formdata = $this->_request->getPost();
        ...
        $result_arr = $this->SFA_Comman->executequery('CALL sp_report_brand_distribution(?,?,?,?,?)',$param_array,'');
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $responce->rows[$i]['cell']=array($row['routecode'],$routename,$row['customercode'],$customername,$row['itemcode'],$itemshortdescription,$row['salesmancode'],$salesmanname,$row['channel'],$row['alternateitemgroupcode'],$row['Outlet_Quality']);
                $i++;
    ...
    */
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route Code'),$this->translate->_('Route Name'),$this->translate->_('Customer Code'),$this->translate->_('Customer'),$this->translate->_('Item Code'),$this->translate->_('Item Description'),$this->translate->_('Salesman code'),$this->translate->_('Salesman'),$this->translate->_('channel'),$this->translate->_('Grouping Code'),$this->translate->_('Outlet Quality'));
        ...
        for($i = 0; $i < count($data); $i++)
        {
            ...
            $column_model_arr[] = array($data[$i]['routecode'],$routename,$data[$i]['customercode'],$customername,$data[$i]['itemcode'],$itemshortdescription,$data[$i]['salesmancode'],$salesmanname,$data[$i]['channel'],$data[$i]['alternateitemgroupcode'],$data[$i]['Outlet_Quality']);
        }
        //pr($column_model_arr,1);
        $data_arr["columns_model"]          		= $column_model_arr;
        $data_arr["config"]["report_title"] 		= $this->translate->_('Brand Distributions').$report_title;
        $data_arr["config"]["report_title_height"] 	= $report_title_height;
        $data_arr["config"]["file_name"]    		= "Brand Distributions";
