...
class Reports_PenaltysalessummaryController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
    ...
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route Code'),$this->translate->_( 'Transaction Date'),$this->translate->_('Transaction Time'),$this->translate->_('Invoice Number'),$this->translate->_('Salesman Code'),$this->translate->_('Customer Code'),$this->translate->_('Customer Name'),$this->translate->_('Itemcode'),$this->translate->_('itemdescription'),$this->translate->_('salesqty'),$this->translate->_('salesprice'),$this->translate->_('Net Amount'));
        ...
        for($i = 0; $i < count($result_arr[0]); $i++)
        {
         ...
         /*   $column_model_arr[$result_arr[0][$i]['routecode']." - ".$routename][$result_arr[0][$i]['transactiondate']][] =
			...
			$column_model_arr[$result_arr[0][$i]['routecode']." - ".$routename][] = array($result_arr[0][$i]['transactiondate'],$result_arr[0][$i]['transactiontime'],$result_arr[0][$i]['invoicenumber'],$result_arr[0][$i]['salesmancode'],$result_arr[0][$i]['customercode'],$customername,
                                                    $result_arr[0][$i]['itemcode'],$result_arr[0][$i]['itemdescription'],$result_arr[0][$i]['salesqty'],$result_arr[0][$i]['salesprice'],
