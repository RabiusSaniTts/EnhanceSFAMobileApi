...
class Reports_TargetandcommissionController extends Reports_Library_Controller_Action_Abstract
{
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->ReportTitle = "Target & Commission";
    ...
    public function targetdataAction()
    {
        ...
        if(!empty($result_arr[1])){
            foreach($result_arr[1] as $row) {
                ...
                $responce->rows[$i]['cell']=array($row['routecode']."-".$row['routename'],$row['salesmancode']."-".$row['salesmanname1'],$row['fromdate'].'-'.$row['todate'],$row['targettype'],$row['packagedescription'],$row['quantity'],$row['commision'],$row['insentivepercent'],$row['insentive'],$row['achieveamount']);
                $i++;
            }
        }
        else
    ...
    */
    public function exportAction()
    {
        ...
        $data_arr["columns"] = array($this->translate->_('Route Name'),$this->translate->_('Salesman Name'),$this->translate->_('From Date & To Date'),$this->translate->_('Target On'),$this->translate->_('Target Group'),$this->translate->_('Value'),$this->translate->_('Commission'),$this->translate->_('Incentive %'),$this->translate->_('Incentive'),$this->translate->_('Achieved'));
