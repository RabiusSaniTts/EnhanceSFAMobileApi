...
*/
class Reports_RoutedepositsummaryController extends Reports_Library_Controller_Action_Abstract
{
    /**
    * @name       init
    * @since      06-10-2012
    ...
    */
    public function indexAction()
    {
        ...
        $this->view->xlsexport_link = $this->view->baseUrl()."/reports/routedepositsummary/export";
        $this->view->cvsexport_link = $this->view->baseUrl()."/reports/routedepositsummary/exportcsv";
     ...
     *
     */
    public function exportnewAction()
    {
        $this->view->params = $params = $this->getRequest()->getParams();
        $this->view->formdata = $formdata = $this->_request->getPost();
        $this->view->css 		= $this->translate->_('CSS');
		...
		//echo $call_sp;exit;
		header("Location: http://enomsfa01.westeurope.cloudapp.azure.com:8095/sfa/excel_download_test/download-routedepositsummary-with-full-fields.php?sp=".$call_sp);
exit();
