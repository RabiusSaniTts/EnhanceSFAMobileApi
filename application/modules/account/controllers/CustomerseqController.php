    ...
    */
    public function arrangecustomerAction()
    {
		...
		elseif($formdata['save'])/* For Save customer */
		{
			...
			$seqmon =0;$seqtue = 0;$seqwed = 0; $seqthr = 0;$seqfri = 0;$seqsat = 0;$seqsun = 0;
			foreach($user_array as $key => $val)
			{
				...
				$param_array[3] = "rp32weeknumber=".$formdata['hdnweek'].",routecode=".$formdata['hdnroute'].",customercode=".$key.",callrestrictiondays1=".$days[0].",callrestrictiondays2=".$days[1].",callrestrictiondays3=".$days[2].",callrestrictiondays4=".$days[3].",callrestrictiondays5=".$days[4].",callrestrictiondays6=".$days[5].",callrestrictiondays7=".$days[6].",monseq=".$monseq.",tueseq=".$tueseq.",wedseq=".$wedseq.",thuseq=".$thrseq.",friseq=".$friseq.",satseq=".$satseq.",sunseq=".$sunseq;//IN input_text TEXT,	  	  
