...
print_r($params);
 //print_r($formdata);      
	...
	$pagingparams = array(
			"show_grid_heading" => false,
			"grid_heading_message" => $this->translate->_('Overview'),
			"show_records_per_page" => isset($formdata["show_records_per_page"])?$formdata["show_records_per_page"]:2500,
			"show_searchbox" => false,
			"show_selectbox" => true,
			"show_editlink" => false,
			"show_deletelink" => false,			
	...
	// called stored procedure for counter
	$result = $this->SFA_Comman->executequery('CALL sp_get_account_customer_itemmust(?,?,?,?,?,?,?)',$param_array,'');
	...
	$data_arr["data"][0]	= $result[1];
      ...
      //  $this->render("ajaxgridmsl");
       ...
       /* $pagingparams = array(
                    ...
                    "show_searchbox" => false,
                    "searchbox_value" => isset($formdata["grid_search_text"])?$formdata["grid_search_text"]:"",
                    "pagename" => $this->translate->_('Customer Item Must List'),
                    "show_selectbox" => true,
                    "show_editlink" => true,
                    "show_deletelink" => false,
					"show_deleteall" => false,
                    "selected_list" => $checked,
                    "primaryid" => "customercode",
					"currentlink" => array("/account/customer/itemmustcustomer/"),
					"editlink" => array("/id/#pattern#/edit/yes","#pattern#"),
					"noeditfields" => array('DivisionCode','customercategory','alternatecode','customername','itemmustkey','itemmustdescription'),
                    "fetch_columns_inquery" => $cols_array,
                    "show_columns" => $columns_show,
                    "nodata_message" => $this->translate->_('No Record(s) Found'),
					"editmode" =>true
