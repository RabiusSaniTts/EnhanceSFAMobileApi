...
// print_r($formdata);      
    ...
    */
    public function itemmustitemgridAction()
    {
        ...
        $columns_array = array('im.actualitemcode','im.itemshortdescription AS itemshortdescription','CONCAT(primary_key,"_",ith.itemmustcode) AS edit_del_primary_id','itd.quantity');        
	...
	$keyparam=$params['key'];}
		...
		$param_array[5] = (int)$get_return_vals['show_records_per_page'];
		$param_array[6] = implode(", ",$columns_array);
		$param_array[7] = 'AND itd.itemmustcode ="'.$keyparam.'"'.$srch;
