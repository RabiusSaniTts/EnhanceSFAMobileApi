...
public class PB51Helper_24052017 extends Plugin {
...
*/
	...
	private static class MyTaskParams {
	    ...
	    MyTaskParams(JSONObject obj, Integer type, String Mac) {
	        this.type = type;
	        this.object = obj;
	        this.mac = Mac;
	    }
...
public class PrintTask extends AsyncTask<MyTaskParams, Boolean,Boolean> {
		...
		public Context PrintingContext;
		
		public PrintTask(Context applicationContext) {
			PrintingContext =applicationContext ; // TODO Auto-generated constructor stub
		}
		...
		protected Boolean doInBackground(MyTaskParams... params) {
			...
			String sPrinterURI = "bt://" + sMacAddr;
			String sUserText ="Hi Sujeeth"; //editUserText.getText().toString();

			LinePrinter.ExtraSettings exSettings = new LinePrinter.ExtraSettings();
			
			exSettings.setContext(PrintingContext);
			...
			try
			{
				...
				File graphicFile = new File (cordova.getActivity().getExternalFilesDir(null), "Sign.bmp");
				
				
				
				
				
				/*File graphicFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
				           + File.separator + "Signaturetest.bmp");
				*/
				...
				*/
				...
				{ 
					...
					lp.writeGraphic(graphicFile.getAbsolutePath(),
							...
							250, // Offset in printhead dots from the left of the page
							400, // Desired graphic width on paper in printhead dots
							800); // Desired graphic height on paper in printhead dots
					//outStream.write(NewLine);
			...
			catch (Exception ex)
			{
				...
				Log.e("Signature ----> LinePrinterError ", "" + ex);
			}
	...
	private void CopyAssetFiles() 
	{
		...
		try
		{
			//byte[] sigimage = object.getString("printoutletitemcode")
			...
			for (String filename : files)
			{
				...
				File outputFile = new File(cordova.getActivity().getExternalFilesDir(null), filename);
	...
	public  File savebitmap(Bitmap bmp) throws IOException {
	   ...
	   /* File f = new File(Environment.getExternalStorageDirectory()
	            + File.separator + "Signaturetest.bmp");
	    */
	    File f = new File(cordova.getActivity().getExternalFilesDir(null), "Sign.bmp");
...
*/
	...
	void printOrderReport(JSONObject object, String... args) {
		...
		try {
			...
			/*Bitmap newBitmap = Bitmap.createBitmap(decodedBitmap);
			int w = decodedBitmap.getWidth();
		     int h = decodedBitmap.getHeight();
		     Bitmap newBitmap1 = Bitmap.createBitmap(decodedBitmap, w/4, h/4, w/2, h/2);
		     */
