...
public class PB51Helper_bk extends Plugin {
...
//					1, object, 1, args[0], 7, 7);
	...
	void printSalesReport(JSONObject object, String... args) {
		...
		try {
			...
			if (object.getString("displayupc").equals("1")) {
				...
				hashArabVales.put("UPO", ArabicTEXT.UPC);
			...
			for (int i = 0; i < jData.length(); i++) {
				...
				if (jInnerData.length() > 0) {
					...
					// outStream.write(NewLine);
					// outStream.write("       ".getBytes());
					// printlines2("FOC  *" + ArabicTEXT.Free + "!", 1,
					// object, 1, args[0], 1, 1);
					// outStream.write(NewLine);
					// UnderlineOff();
					// BoldOff();
					...
					if (j != 0 && j != 6) {
						...
						if (!isoutlet) {
							...
							if (jTotal.has(headers.getString(j))) {
								strTotal = strTotal
										+ getAccurateText(
												jTotal.getString(headers
														.getString(j)
														.toString()),
												hashValues.get(headers
														.getString(j)
														.toString())
														+ MAXLEngth,
												hashPositions.get(headers
				...
				if (jInnerData.length() > 0) {
					...
					// if (!object.getString("LANG").equals("en")) {
					printlines2(ArabicTEXT.headerbottomrevereseArabic, 1,
							object, 1, args[0], 1, 1);
					printlines2(ArabicTEXT.headerrevereseArabic, 1, object, 1,
							args[0], 1, 1);
					...
					if (strHeaderBottom.length() > 0) {
						CompressOn();
						printlines2(strHeaderBottom, 1, object, 1, args[0], 1,
								1);
						CompressOff();
					}
					// }
					...
					for (int m = 0; m < jArr.length(); m++) {
						if (m != 0 && m != 6) {
							...
							if (!isoutletdata) {
								...
								strData = strData+ getAccurateText(
												itemDescrion,
												m==11?60:hashValues
														.get(headers
																		.getString(
			...
			BoldOn();
			printlines2(
					(getAccurateText("NET SALES", 20, 0)
							+ getAccurateText(" : ", 3, 0)
			...
			if (object.has("PaymentType")
				...
				if (!object.getString("LANG").equals("en")) {
					printlines2(
							getAccurateText("PAYMENT DETAILS   " + "*"
									+ ArabicTEXT.PaymentDetails + "!", 80, 1),
	...
	private void printlines1(String data, int ln, JSONObject object, int sts,
		...
		if (sts == 2) {
			...
			outStream.write(NewLine);
			outStream.write(NewLine);
			printArabic(getAccurateText(object.getString("footeraddress1"), 80,
					1));
			printArabic(getAccurateText(object.getString("footeraddress2"), 80,
					1));
			outStream.write(NewLine);
			outStream.write(NewLine);
	...
	private void headerprint(JSONObject object, int type) throws JSONException {
		try {
			...
			DoubleWideOff();
			outStream.write(NewLine);
			printArabic(getAccurateText(object.getString("companyaddress"), 80,
					1));
			outStream.write(NewLine);
			printArabic(getAccurateText(object.getString("arbcompanyname"), 80,
					1));
			outStream.write(NewLine);
			outStream.write(NewLine);
			printArabic(getAccurateText("ROUTE: " + object.getString("ROUTE"),
					40, 0)
					+ getAccurateText("DATE:" + object.getString("DOC DATE")
							+ " (" + object.getString("TIME") + ")", 40, 2));
			outStream.write(NewLine);
			...
			if (type != 3 || type != 6 || type != 4 || type != 5 || type != 7) {
				if (object.has("invheadermsg")
					...
					DoubleWideOn();
					outStream
							.write(object.getString("invheadermsg").getBytes());
					BoldOff();
					DoubleWideOff();
			...
			if (type == 1) {
				...
				if (!object.getString("LANG").equals("en")) {
					printArabic(getAccurateText("*" + ArabicTEXT.Receipt + "!:"
							+ object.getString("RECEIPT") + "", 40, 1));
				...
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("DEPOSIT SUMMARY", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
				outStream.write(NewLine);
				...
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("SALES SUMMARY", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
				outStream.write(NewLine);
				...
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("ROUTE ACTIVITY LOG", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
				outStream.write(NewLine);
				...
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("ROUTE SUMMARY", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
				outStream.write(NewLine);
				...
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("STALES/DAMAGE SUMMARY", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
				outStream.write(NewLine);
	...
	private void headerinvprint(JSONObject object, int invtype)
		...
		try {
			...
			if (invtype == 1) {
				...
				outStream.write(getAccurateText("LOAD TRANSFER SUMMARY", 40, 1)
						.getBytes());
			} else if (invtype == 3) {
				outStream.write(getAccurateText("END INVENTORY SUMMARY", 40, 1)
						.getBytes());
			} else if (invtype == 5) {
				outStream.write(getAccurateText("LOAD REQUEST", 40, 1)
						.getBytes());
			} else if (invtype == 6) {
				outStream
						.write(getAccurateText("COMPANY CREDIT SUMMARY", 40, 1)
								.getBytes());
			}
	...
	private void headervanstockprint(JSONObject object, int type)
		...
		try {
			...
			if (type == 4) {
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("VAN STOCK SUMMARY ", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
			}else if (type == 10) {
				BoldOn();
				DoubleWideOn();
				outStream.write(getAccurateText("ITEM SALES SUMMARY ", 40, 1)
						.getBytes());
				DoubleWideOff();
				BoldOff();
			}  
				...
				outStream.write(getAccurateText("TEMPORARY CREDIT SUMMARY", 40,
						1).getBytes());
				DoubleWideOff();
				BoldOff();
			}
