...
public class DotmatHelper1 extends Plugin {
		...
		try {
			...
			if (object.getString("displayupc").equals("1")) {
				...
				if (printoultlet != 0) {
					...
					hashValues.put("BARCODE", 2);
					hashValues.put("DESCRIPTION", 22);  //25
					hashValues.put("DISCOUNT", 10);
				} else {

					hashValues.put("OUTLET CODE", 0);
					hashValues.put("BARCODE",2);
					hashValues.put("DESCRIPTION", 12);	//15
					hashValues.put("DISCOUNT", 10);
				...
				if (printtax > 0) {
		              ...
		              if(excTot>0){
	                    ...
	                    if(vatTot>=0){
	                    	...
	                    	hashValues.put("AMOUNT AFTER VAT", 16);
	                    	hashValues.put("GROSS AMT", 9);
	                    }
				...
				hashValues.put("OUTLET CODE", 8);
				hashValues.put("BARCODE", 2);
				hashValues.put("DESCRIPTION", 22);  //32
					...
					for (int m = 0; m < jArr.length(); m++) {
						if (m != 0 && m != 6) {
							...
							if (!isoutletdata) {
								...
								/*else if(m==1) {
									itemDescrion = "" + jArr.getString(1) + "";   //item code
								}
								else if(m==2) {
									itemDescrion = "" + jArr.getString(15) + "";   //barcode
								}
								else if(m==3) {
									itemDescrion = "" + jArr.getString(2) + "";   //item code
								}
								else if(m==4) {
									itemDescrion = "" + jArr.getString(3) + "";   //item code
								}
								else if(m==5) {
									itemDescrion = "" + jArr.getString(4) + "";   //item code
								}
								else if(m==6) {
									itemDescrion = "" + jArr.getString(5) + "";   //item code
								}
								else if(m==7) {
									itemDescrion = "" + jArr.getString(6) + "";   //item code
								}
								else if(m==8) {
									itemDescrion = "" + jArr.getString(7) + "";   //item code
								}   else */
								 if(m==9) {
								...
								{
									itemDescrion = "" + jArr.getString(9) + "";   //d
								}else if(m==11)
								{
