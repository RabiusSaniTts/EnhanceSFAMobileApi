...
function getCustomerMasterData($customercode,$dbcon) {
	...
	$check_user = "
                select DivisionCode ,customercode,customername,ROUND(creditlimit,2),creditlimitdays,graceperiod from customermaster cm
                    inner join company cmp on cmp.name = cm.DivisionCode 
                    inner join useraccesscodes u on u.cmpycode = cmp.cmpycode 
                    WHERE alternatecode = '$customercode' and u.username = '$uname' ";
